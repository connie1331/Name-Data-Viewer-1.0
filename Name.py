#******************************************************************************
# Author:           Khanh Vu
# Lab:              Lab_6 - Defining Name class
# Date:             02.15.2022
# Description:      The Name class is stored in a module named Name (Name.py).  This code use object(s) from
#                   the Database class to define a static method.This code defines a constructor that
#                   stores values for name, year, gender, and count for the object. This code also has setters and
#                   getters for the 4 properties above. Then, it defines a static method called readName() which call
#                   Database.readName() and return its result.
...
class Name:
    ...
    def readNames():
        ...
        listOfnameDict = Database.readNames()    # a list of name dictionary objects
